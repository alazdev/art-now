...
<head>
  ...
  <title>Halaman Admin ArtNow</title>
  <!-- BOOTSTRAP STYLES-->
...
<body>
  <div id="wrapper">
    <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
      ...
      float: right;
      font-size: 16px;">Last access : (Koding belum Dibuat) &nbsp;
      ...
      <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
          <li class="text-center">
            <img src="assets/img/aku.jpg" class="user-image img-responsive"/>
          </li>
          ...
          <li><a href="index.php?halaman=user"><i class="fa fa-user  "></i> User</a></li>
          <li><a href="index.php?halaman=arsitek"><i class="fa fa-user  "></i> Arsitek</a></li>
    ...
    <div id="page-wrapper" >
      <div id="page-inner">
        ...
        if (isset($_GET['halaman'])) {
          ...
          }else if ($_GET['halaman']=='hapusarsitek') {
            include 'hapusarsitek.php';
          }else if($_GET['halaman']=='ubahproduk'){
            include 'ubahproduk.php';
          }else if ($_GET['halaman']=='tambahuser') {
            include 'tambah_user.php';
          }else if ($_GET['halaman']=='tambaharsitek') {
            include 'tambah_arsitek.php';
          }else if ($_GET['halaman']=='edituser') {
            include 'edit_user.php';
          }else if ($_GET['halaman']=='editarsitek') {
            include 'edit_arsitek.php';
