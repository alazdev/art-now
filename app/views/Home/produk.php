                                ...
                                <li class="wow fadeInUp">
                                    <div class="blog_comment">
                                        ...
                                        <div class="blog_comment_data">
                                            <h3><?php if(isset($_SESSION['email'])) { ?><?=($komen['email'] == $_SESSION['email']) ? '<i>Kamu</i>':$komen['nama_lengkap']?><?php } else { echo $komen['nama_lengkap']; } ?><?=($komen['id_user'] == $data['id_user']) ? ' <sup>[Pemilik]</sup>':''?> <span>- <?=date('d F Y', strtotime($komen['dibuat_pada']))?></span></h3>
                                            <p><?=$komen['komen']?></p>
                                        </div>
                                    </div>
                                    <div class="blog_comment_meta">
                                        <ul>
                                            <li>
                                                <a class="reply" data-value="<?=$komen['id_komen']?>" href="javascript:;"><svg xmlns="http://www.w3.org/2000/svg" width="21px" height="13px"><path fill-rule="evenodd"  fill="rgb(255, 54, 87)" d="M6.125,2.599 L6.125,-0.000 L-0.000,6.066 L6.125,12.132 L6.125,9.533 L2.625,6.066 L6.125,2.599 ZM11.375,3.466 L11.375,-0.000 L5.250,6.066 L11.375,12.132 L11.375,8.579 C15.750,8.579 18.812,9.966 21.000,12.999 C20.125,8.666 17.500,4.332 11.375,3.466 Z"/></svg></a>
                                            </li>
                                        </ul>
                                        ...
                                        <?php foreach($data['reply_komens'] as $reply_komen) { if($reply_komen['id_reply_komen'] == $komen['id_komen']) { ?>
                                            <li>
                                                <div class="blog_comment">
                                                    ...
                                                    <div class="blog_comment_data">
                                                        <h3><?php if(isset($_SESSION['email'])) { ?><?=($reply_komen['email'] == $_SESSION['email']) ? '<i>Kamu</i>':$reply_komen['nama_lengkap']?><?php } else { echo $reply_komen['nama_lengkap']; } ?><?=($reply_komen['id_user'] == $data['id_user']) ? ' <sup>[Pemilik]</sup>':''?> <span>- <?=date('d F Y', strtotime($reply_komen['dibuat_pada']))?></span></h3>
                                                ...
                                                <div class="blog_comment_meta">
                                                    ...
                                                    <?php if(isset($_SESSION['email'])) { if($reply_komen['email'] == $_SESSION['email']){ ?>
                                                        ...
                                                        <ul class="comment_action">
                                                            <li><a href="<?=BASEURL.'/home/hapus_komen/'.$reply_komen['id_komen']?>"><svg xmlns="http://www.w3.org/2000/svg" width="11px" height="16px"><path fill-rule="evenodd"  fill="rgb(112, 112, 112)" d="M9.485,4.765 L1.578,4.765 C0.746,4.765 0.072,5.413 0.072,6.214 L0.888,14.551 C0.888,15.351 1.563,16.000 2.395,16.000 L8.795,16.000 C9.627,16.000 10.302,15.351 10.302,14.551 L10.992,6.214 C10.991,5.413 10.317,4.765 9.485,4.765 ZM3.523,13.463 C3.523,13.863 3.186,14.186 2.771,14.186 C2.355,14.186 2.018,13.862 2.018,13.463 L2.018,6.939 C2.018,6.539 2.355,6.214 2.771,6.214 C3.186,6.214 3.523,6.539 3.523,6.939 L3.523,13.463 L3.523,13.463 ZM6.159,13.463 C6.159,13.863 5.822,14.186 5.406,14.186 C4.990,14.186 4.653,13.862 4.653,13.463 L4.653,6.939 C4.653,6.539 4.990,6.214 5.406,6.214 C5.822,6.214 6.159,6.539 6.159,6.939 L6.159,13.463 ZM8.795,13.463 C8.795,13.863 8.458,14.186 8.042,14.186 C7.626,14.186 7.289,13.862 7.289,13.463 L7.289,6.939 C7.289,6.539 7.626,6.214 8.042,6.214 C8.458,6.214 8.795,6.539 8.795,6.939 L8.795,13.463 ZM1.176,4.041 L10.292,1.784 C10.796,1.659 11.099,1.166 10.970,0.681 C10.840,0.197 10.327,-0.095 9.823,0.028 L7.021,0.722 C6.761,0.351 6.282,0.157 5.807,0.274 L4.713,0.546 C4.238,0.663 3.916,1.056 3.874,1.501 L0.707,2.286 C0.203,2.410 -0.099,2.904 0.030,3.389 C0.159,3.873 0.673,4.164 1.176,4.041 Z"/></svg> Hapus</a></li>
                                                        </ul>
                                                    <?php } }?>
                                                </div>
                                            </li>
